...
{"file": "historias/01_portada.png", "photo": os.path.join(INV, "mountain_m.png"), "ov": .45, "bg": C["carbon"], "fg": C["crema"], "accent": C["arcilla"], "blocks": [
    ...
    ("title", "Gente real,\npiel real", 96), ("gap", 50),
    ("body", "Acá no hay modelos ni guiones. Lo que ves es gente que eligió el producto y lo usa donde vive: montaña, mar, ruta.", 38, 780),
]},
...
{"file": "ciencia/02_formula.png", "bg": C["hueso"], "fg": C["bosque700"], "accent": C["bosque"], "blocks": [
    ("eyebrow", "Fórmula declarada ante ANMAT"), ("gap", 60),
    ("mono", ["Aceite de almendras ... 23,55%",
              "Óxido de zinc ......... 20,00%",
              "Dióxido de titanio .... 10,00%",
              "Cacao .................. 9,25%",
              "Aceite de jojoba ....... 8,00%",
              "Cera de abeja .......... 7,40%",
              "Manteca de karité ...... 7,40%",
              "Aceite de coco ......... 7,00%",
              "Manteca de cacao ....... 5,55%",
              "Cúrcuma ................ 1,85%"], 30),
    ("gap", 50),
    ("body", "La fórmula completa, con porcentajes. Así de simple.", 38, 760),
]},
